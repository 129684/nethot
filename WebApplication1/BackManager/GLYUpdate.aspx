<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GLYUpdate.aspx.cs" Inherits="WebApplication1.BackManager.GLYUpdate" %>
        	...
        	<div id="basicform" class="subcontent">
               ...
               <asp:TextBox ID="Yname" runat="server" type="text" name="input1" class="smallinput" Width="161px"></asp:TextBox>
                        ...
                        <p class="stdformbutton">
                            ...
                            <asp:Button ID="GULUP" runat="server" Text="修改" class="submit radius2"  OnClick="GULUP_Click"/>
