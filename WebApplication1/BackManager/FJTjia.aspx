<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FJTjia.aspx.cs" Inherits="WebApplication1.BackManager.FJTjia" %>
                    ...
                    <div class="contenttitle2">
                        ...
                        <p>
                            ...
                            <span class="field"><%--<input type="text" name="input1" class="smallinput" />--%>
                                <asp:TextBox ID="TextBox1_" runat="server" Width="263px"></asp:TextBox>
                            </span>
                        ...
                        <p>
                            ...
                            <span class="field"><%--<input type="text" name="input2" class="mediuminput" />--%>
                               &nbsp;&nbsp; <asp:TextBox ID="TextBox1_je" runat="server"></asp:TextBox>
                            </span>
                        </p>
                        ...
                        <p>
                            ...
                            <span class="field"><%--<input type="text" name="input3" class="longinput" />--%>
                                <asp:DropDownList ID="DropDownList1_fjxz" runat="server" Width="50px" Height="30px">
                                    <asp:ListItem Selected="True">空房</asp:ListItem>
                        ...
                        <p class="stdformbutton">
                            ...
                            <asp:Button ID="FJTJ_BUTT" runat="server" Text="添加" class="submit radius2"  OnClick ="FJTJ_BUTT_Click"/>
