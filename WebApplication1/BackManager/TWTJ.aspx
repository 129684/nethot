<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TWTJ.aspx.cs" Inherits="WebApplication1.BackManager.TWTJ" %>
               ...
               <p>
                        ...
                        <p>
                            ...
                            <span class="field"><%--<input type="text" name="input1" class="smallinput" />--%>
                               ...
                               &nbsp;&nbsp;
                                <br />
                                <asp:Button ID="Button1_uplodpic" CommandArgument='<%#Eval("tpID") %>' runat="server" Text="上传图片"  OnClick="Button1_uplodpic_Click1" />
