<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Fjbianji.aspx.cs" Inherits="WebApplication1.BackManager.Fjbianji" %>
    ...
    <div class="centercontent">
        ...
        <div id="contentwrapper" class="contentwrapper">
        	<div id="basicform" class="subcontent">
                ...
                <asp:HiddenField ID="HiddenField1_xiugai" runat="server" />
                        ...
                        <p>
                            ...
                            <span class="field"><%--<input type="text" name="input2" class="mediuminput" />--%>
                               &nbsp;&nbsp; <asp:DropDownList ID="DropDownList1_sex" runat="server" Width="50px" >
                                    <asp:ListItem Selected="True">入住</asp:ListItem>
                        ...
                        <p class="stdformbutton">
                            ...
                            <asp:Button ID="GULUP" runat="server" Text="操作" class="submit radius2"   OnClick ="GULUP_Click"/>
